...
import { FileText, FileVideo, AlignLeft, Image as ImageIcon, ArrowRight, Inbox } from "lucide-react";
...
export default function RecentContent({ content, loading = false }: RecentContentProps) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm transition-shadow duration-200 hover:shadow-md">
      <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5">
        <div>
          <h3 className="text-base font-semibold text-slate-900">Recent Content</h3>
          <p className="mt-1 text-sm text-slate-500">Latest content across all folders</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center px-6 py-14 text-center">
          ...
          <p className="mt-4 text-sm font-medium text-slate-900">No content yet</p>
